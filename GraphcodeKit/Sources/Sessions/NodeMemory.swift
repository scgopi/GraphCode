...
public enum NodeMemory {
  ...
  public static func writeWakeDigest(
    projectPath: String, nodeID: UUID, mailboardEnabled: Bool = false,
    ...
    if mailboardEnabled {
      // The reminder half of the Mailboard. The briefing teaches the board's verbs to
      ...
      lines.append(
        "The project's Mailboard is on: other loops may have left findings for you. "
          + "Check at the start of a pass — graphcode mailboard sync <project-path> — "
